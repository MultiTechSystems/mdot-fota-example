...
void display_config() {
    ...
    logInfo("=====================");
    logInfo("application version ------ %s", APPLICATION_VERSION);
    ...
    logInfo("gen app key -------------- %s", mts::Text::bin2hexString(dot->getGenAppKey()).c_str());
    logInfo("========================");
...
const char* lora_app_event_code_to_str(lora::app::EventCode ec)
{
    switch (ec) {
        case lora::app::EVENT_SYSTEM_RESET:
            return "system reset";
        case lora::app::EVENT_CLOCK_SYNCHRONIZED:
            return "clock synchronized";
        case lora::app::EVENT_MULTICAST:
            return "multicast";
        case lora::app::EVENT_MULTICAST_GROUP_JOINED:
            return "multicast group joined";
        case lora::app::EVENT_MULTICAST_GROUP_LEFT:
            return "multicast group left";
        case lora::app::EVENT_MULTICAST_SESSION_SETUP:
            return "multicast session setup";
        case lora::app::EVENT_MULTICAST_SESSION_STARTED:
            return "multicast session started";
        case lora::app::EVENT_MULTICAST_SESSION_CLOSED:
            return "multicast session closed";
        case lora::app::EVENT_FOTA:
            return "fota";
        case lora::app::EVENT_FOTA_SESSION_CREATED:
            return "fota session created";
        case lora::app::EVENT_FOTA_SESSION_RESTORED:
            return "fota session restored";
        case lora::app::EVENT_FOTA_SESSION_STARTED:
            return "fota session started";
        case lora::app::EVENT_FOTA_FILE_RECEIVED:
            return "fota file received";
        case lora::app::EVENT_FOTA_FILE_VALID:
            return "fota file valid";
        case lora::app::EVENT_FOTA_FILE_INVALID:
            return "fota file invalid";
        case lora::app::EVENT_FOTA_SESSION_ABORTED:
            return "fota session aborted";
        case lora::app::EVENT_FOTA_SESSION_COMPLETE:
            return "fota session complete";
        default:
            return "unknown";
    }
}